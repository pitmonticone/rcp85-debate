...
* SSP framework has advantages and disadvantages, I am happy to acknowledge both, and I happy to use (and do) the framework knowing the issues.
* I think RCP85 is infeasible and for a variety of reasons __I__ would not use it (or use in very restrictive contexts).
